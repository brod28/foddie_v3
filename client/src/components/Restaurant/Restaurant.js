...
class Restaurant extends Component {
  ...
  render() {
    ...
    if (this.state.restaurant.metadata) {
      restaurantName = Header(this.state.restaurant)
    }
    ...
    if (this.state.reviews) {
      save_restaurant = SaveSection(this.state.restaurant)
    }
